...
//   .catch(err => console.log(`2: ${err.message} 💥`)).finally(() => console.log('3: Finished getting location'))ereAmI();
...
// using Async await to catch error
/* (async function () {
  try {
...
// Running multiple Async in parallel
